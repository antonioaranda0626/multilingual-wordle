document.addEventListener("DOMContentLoaded", () => {
    ...
    enterBtn.addEventListener("click",() => {
        ...
        if(correctWord.length != 5){
            ...
            fetch(`https://international-wordle.herokuapp.com/make-custom`)
    ...
    function fetchWordle(languageChosen){
        fetch(`https://international-wordle.herokuapp.com/${languageChosen}`)
            .then(response => response.json())
            .then(json => {
    ...
    function handleSubmitRequest(languageChosen){
        ...
        */
        ...
        fetch(`https://international-wordle.herokuapp.com/${checkLanguage}/?word=${currentGuess.toLowerCase()}`)
            .then(response => response.json())
            .then(json => {
